...
import { 
  ...
  FiHash, FiSave, FiEye, FiEyeOff, FiX, FiPlus, FiArrowLeft
} from 'react-icons/fi';
...
const BlogEdit = () => {
  ...
  useEffect(() => {
    const fetchBlog = async () => {
      try {
        // Fetch blog by ID directly (works for author and admin)
  ...
  // Set editor content when both editor and content are ready
  useEffect(() => {
  ...
  return (
    <div className="max-w-4xl mx-auto px-4 py-8">
      ...
      <h1 className="text-3xl font-bold text-white mb-8">Edit Blog</h1>
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        ...
        <div className="flex items-center justify-between pt-4 border-t border-gray-700">
          ...
          >
            ...
            <span>{saving ? 'Saving...' : 'Update Blog'}</span>
          </button>
        </div>
      </form>
    </div>
